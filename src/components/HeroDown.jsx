...
const HeroDown = () => {
  return (
    <div className="w-sm lg:w-full mx-auto p-10 mt-40 bg-gray-300 ">
      <div className="relative w-full lg:w-[1024px] mx-auto lg:relative">
        <div className="absolute w-[330px] lg:mx-auto lg:mx-0 lg:w-[1024px] h-[150px] p-5 lg:p-10 bgshort rounded-lg lg:absolute -top-80 ">
        ...
        <div className="mt-20 flex flex-col lg:flex lg:flex-row gap-20 lg:gap-5 relative">
          {statistics.map((items, index) => {
            return (
              ...
              >
                <div className="flex items-center justify-center rounded-full w-[80px] h-[80px]  bg-[hsl(257,27%,26%)] mb-2 absolute -top-10 left-25 lg:left-5">
                  <img
                    src={items.icon}
                    alt="img"
                ...
                <div className="w-full lg:w-[200px] mt-15">
                  <h1 className="font-[700] text-[18px]">{items.title}</h1>
                </div>
